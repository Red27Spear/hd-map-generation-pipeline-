...
| `compare_pointcloud_poles_osm.py` | groups poles by nearest OSM entity (not the other way around, matching OSM's own logical-intersection-point data model) and reports the match distance |
